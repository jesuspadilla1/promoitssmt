...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-07-2020 a las 20:00:15
...
CREATE TABLE `redes_sociales` (
  ...
  `dir_insta` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `otro` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
